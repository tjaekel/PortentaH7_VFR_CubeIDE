...
/**
  ...
  * @retval HAL status
  */
HAL_StatusTypeDef __attribute__((section(".itcmram"))) USB_WritePacket(USB_OTG_GlobalTypeDef *USBx, uint8_t *src,
...
/**
  ...
  */
void * __attribute__((section(".itcmram"))) USB_ReadPacket(USB_OTG_GlobalTypeDef *USBx, uint8_t *dest, uint16_t len)
{
  uint32_t USBx_BASE = (uint32_t)USBx;
  uint8_t *pDest = dest;
  uint32_t pData;
