...
int I2C_PMIC_Initialize(void)
{
	...
	// LDO2 to 1.8V
	  ...
	  data[0]=0x39;
	  data[1]=0x6;			//6 = 3.0V, 7 = 3.3V, 5 = 2.5 - but I do not see it
	  /*
	  ...
	  data[0]=0x3B;
	  data[1]=0xF;				//was 0xF - 0x1 to change to STANDBY voltage!
	  ...
	  data[0]=0x33;
	  data[1]=0x6;			//but STANDBY mode is not entered - why not?
	  I2C_PMIC_Write(PMIC_I2C_SLAVE_ADDR, data, sizeof(data));
	  ...
	  data[0]=0x35;
	  data[1]=0xF;				//was 0xF - 0x1 to change to STANDBY voltage - does NOT work
