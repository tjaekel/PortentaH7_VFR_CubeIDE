...
void TypeParseStruct(struct ParseState *Parser, struct ValueType **Typ, int IsStruct)
{
    ...
    *Typ = TypeGetMatching(Parser, &UberType, IsStruct ? TypeStruct : TypeUnion, 0, LexValue->Val->Identifier);
    ...
    //XXXX: this init was missing, if reused memory it keeps counting!
    (*Typ)->Sizeof = 0;
...
int TypeParseFront(struct ParseState *Parser, struct ValueType **Typ)
{
    ...
    *Typ = NULL;
    ...
    switch (Token)
    {
        ...
        //extend for our types, without to need typedef
        case TokenUint32Type: *Typ = &UnsignedLongType; break;
        case TokenInt32Type: *Typ = &LongType; break;
        case TokenUint16Type: *Typ = &UnsignedShortType; break;
        case TokenInt16Type: *Typ = &ShortType; break;
        case TokenUint8Type: *Typ = &CharType; break;
        case TokenInt8Type: *Typ = &CharType; break;
#ifndef NO_FP
