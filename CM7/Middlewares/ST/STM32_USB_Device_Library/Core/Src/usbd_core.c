...
/**
  ...
  * @retval status
  */
USBD_StatusTypeDef __attribute__((section(".itcmram"))) USBD_LL_SetupStage(USBD_HandleTypeDef *pdev, uint8_t *psetup)
{
  USBD_StatusTypeDef ret;
...
/**
  ...
  * @retval status
  */
USBD_StatusTypeDef __attribute__((section(".itcmram"))) USBD_LL_DataOutStage(USBD_HandleTypeDef *pdev,
...
/**
  ...
  * @retval status
  */
USBD_StatusTypeDef __attribute__((section(".itcmram"))) USBD_LL_DataInStage(USBD_HandleTypeDef *pdev,
                                       uint8_t epnum, uint8_t *pdata)
{
  USBD_EndpointTypeDef *pep;
  USBD_StatusTypeDef ret;
...
/**
  ...
  */
void * __attribute__((section(".itcmram"))) USBD_GetEpDesc(uint8_t *pConfDesc, uint8_t EpAddr)
{
...
/**
  ...
  * @retval next header
  */
USBD_DescHeaderTypeDef * __attribute__((section(".itcmram"))) USBD_GetNextDesc(uint8_t *pbuf, uint16_t *ptr)
{
